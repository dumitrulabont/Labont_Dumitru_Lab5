...
namespace Labont_Dumitru_Lab5.PhoneNumbersDataSetTableAdapters {
    ...
    public partial class PhoneNumbersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PhonenNumbers] WHERE (([Id] = @Original_Id) AND ([Phonenum] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PhonenNumbers] ([Phonenum], [Subscriber]) VALUES (@Phonenum, @" +
                "Subscriber);\r\nSELECT Id, Phonenum, Subscriber FROM PhonenNumbers WHERE (Id = SCO" +
                "PE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PhonenNumbers] SET [Phonenum] = @Phonenum, [Subscriber] = @Subscriber WHERE (([Id] = @Original_Id) AND ([Phonenum] = @Original_Phonenum) AND ([Subscriber] = @Original_Subscriber));
SELECT Id, Phonenum, Subscriber FROM PhonenNumbers WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Phonenum, Subscriber FROM dbo.PhonenNumbers";
